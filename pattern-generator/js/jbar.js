...
;(function ($) {
	...
	$.jBar = function(options) {
		...
		var jbar_html = '<div id="jbar" class="jbar">' + '<span class="jbar-cta">'
					  + '<p class="text">' + calltoAction + '<a target="_blank" href="' + buttonLink + '">'
	    ...
	    // jBar Styles
	    var styles = '<style>' + '.jbar{background:' + backgroundColor + ';top:0;left:0;right:0;height:46px;z-index:999998;color:#333;border-bottom:1px solid ' + borderColor + ';display:none;}'
