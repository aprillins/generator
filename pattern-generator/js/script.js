...
$(document).ready(function () {
	...
	$.jBar({
		...
		backgroundColor: '#fffae5', // Background Color
		borderColor: '#FFF', // Background Color
		buttonTextColor: '#FFF', // Button Text
		buttonColor: '#f15e25', // Button Color
		buttonColorHover: '#222', // Button Color Hover
		calltoAction: 'Check out my new project, Sidebar: get the 5 best design links of the day!', // Call to action text
		buttonText: 'See today\'s 5 links', // Button Text
		buttonLink: 'http://sidebar.io' // Hyperlink from button
	});
